...
const TABS = ["Todos", "Área Interna", "Área Externa", "Espaços Comuns", "Espaços de Lazer"]
        ...
        <div className="text-center mb-12">
          <div>
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Descubra a harmonia e funcionalidade de cada espaço, desde áreas internas e externas até espaços comuns e de lazer.
            </p>
          </div>
        </div>
